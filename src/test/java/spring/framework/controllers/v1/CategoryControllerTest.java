...
import spring.framework.controllers.v1.CategoryController;
import spring.framework.exceptions.ResourceNotFoundException;
import spring.framework.services.CategoryService;
...
public class CategoryControllerTest {
    ...
    public void testGetByNameNotFound() throws Exception {
        ...
        mockMvc.perform(get(CategoryController.BASE_URL + "/123")
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON))
